...
namespace tpmodul7_kelompok_8
{
    ...
    public class KuliahMahasiswa2311104075
    {
        public List<Course> Courses { get; set; }

        public static void ReadJSON()
        {
            string filePath = "tp7_2_2311104075.json";

            try
            {
                string jsonData = File.ReadAllText(filePath);

                KuliahMahasiswa2311104075 kuliahMahasiswa = JsonSerializer.Deserialize<KuliahMahasiswa2311104075>(jsonData);
